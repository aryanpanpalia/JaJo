...
export default function CustomerManagement() {
    ...
    function Menu() {
        ...
        async function submit() {
            ...
            if (customerIDError) {
                console.log("Rider-customerManagement-submit: ", customerIDError)
                return
            }
            if (customerID === null) {
            ...
            if (insertError) {
                console.log("Rider-customerManagement-submit: ", insertError)
            }
    ...
    async function fetchCustomers() {
        ...
        if (error) {
            console.log("Rider-customerManagement-fetchCustomers: ", error)
        } else {
